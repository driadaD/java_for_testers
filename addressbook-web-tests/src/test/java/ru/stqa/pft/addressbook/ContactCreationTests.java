...
public class ContactCreationTests {
  ...
  public void testContactCreation() throws Exception {
    gotoAddNew();
    fillContactForm(new ContactGroup("Angry", "Birds", "preskot srit", "89990009900", "pochta@mail.ru"));
  ...
  private void fillContactForm(ContactGroup contactGroup) {
    ...
    wd.findElement(By.name("address")).sendKeys(contactGroup.getAdress());
    wd.findElement(By.name("mobile")).click();
    wd.findElement(By.name("mobile")).clear();
    wd.findElement(By.name("mobile")).sendKeys(contactGroup.getMobilephone());
